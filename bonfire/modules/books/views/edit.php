<div class="row">
	<div class="col-lg-12">
		<h1> Edit Books <small>Edit Books Data</small></h1>
		<ol class="breadcrumb">
			<li>
		...
		<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    		<fieldset>
		        ...
		        <div class="form-group <?php echo form_error('category_name') ? 'error' : ''; ?>">
		        	...
		        	<?php echo form_dropdown('books_category_name',$student_category_list, set_value('books_category_name', isset($books['category_name']) ? $books['category_name'] : ''),'','class="form-control" id="category_name"');?>
		        ...
		        <div class="form-group <?php echo form_error('class_name') ? 'error' : ''; ?>">
		        	...
		        	<?php echo form_dropdown('books_class_name',$student_class_list, set_value('books_class_name', isset($books['class_name']) ? $books['class_name'] : ''),'','class="form-control" id="class_name"');?>
